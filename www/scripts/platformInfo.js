...
document.write('<p>This web app was created by <a href="http://www.brookes.ac.uk" target="_blank">Oxford Brookes University</a> to allow our current students to easily record incidents and reflections around employability skills that they have experienced whilst at Brookes.  These records are very useful when preparing for a job interview.</p>');
document.write('<p>Students are required to login with the same student number and password combination that they normally use for accessing Moodle.</p>');
