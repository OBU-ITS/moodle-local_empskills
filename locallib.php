...
/**
 * Library of functions for employability skills outside of the core api
 *
 * @package    empskills
 * @category   local
...
class empskills_portfolio_caller extends portfolio_module_caller_base {
    ...
    function __construct($callbackargs) {
        ...
        if (!$this->method) {
            throw new portfolio_caller_exception('mustprovidemethod', 'empskills');
        }
    }
    /**
     * @global object
    ...
    public function load_data() {
        ...
        if (!$this->discussion = $DB->get_record('forum_discussions', $dbparams)) {
            throw new portfolio_caller_exception('invalidmethod', 'forum');
        }
    ...
    function prepare_package() {
        ...
        if ($this->attachment) { // simplest case first - single file attachment
            ...
            if ($writingleap) {
                ...
                $selection = new portfolio_format_leap2a_entry('forumdiscussion' . $this->method,
