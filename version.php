...
$plugin->component = 'local_empskills'; // Full name of the plugin (used for diagnostics): plugintype_pluginname
...
$plugin->release = 'v1.2.3'; //Optional - Human-readable version name
?>
